...
public class UsuarioService implements IUsuarioSerice, UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (usuario == null){
            logger.error("Error en el login, no existe el usuario '" + usuario.getNombre() + "' en sistema");
            throw new UsernameNotFoundException("Error en el login, no existe el usuario '" + usuario.getNombre() + "' en sistema");
        }
